...
export default function ListTicket() {
    ...
    console.log("🚀 ~ file: ListTicket.jsx:95 ~ ListTicket ~ user:", user)
    ...
    console.log("🚀 ~ file: ListTicket.jsx:93 ~ ListTicket ~ idBooking:", id)
    ...
    return (
        <div className="bg-orange-200 container_booking">
            <div className=" "
            // style={{
            ...
            >
                <div className="flex py-1 gap-5 justify-between w-full mt-20">
                    <div className="pl-6">
                        ...
                        <div className="grow grid grid-cols-16 gap-3  mt-8 ">
                            {renderBooking()}
                        </div>
                    ...
                    <div className="bg-slate-800 text-white mt-20 h-full mr-6">
                        {renderImg()}
                        {renderTicket()}
                        <div
